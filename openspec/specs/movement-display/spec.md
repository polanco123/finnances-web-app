# Capability: movement-display

## Purpose

Display financial movements in a structured list item format with proper currency formatting and responsive layout.

## Requirements

### Requirement: Movement list item display
The system SHALL display movement information in a structured list item format with clear visual hierarchy.
