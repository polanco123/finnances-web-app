...
#### Scenario: Input dark mode display
- **WHEN** dark mode is active and an input field is rendered
- **THEN** the input SHALL have a semi-transparent background, light text color, and subtle glassmorphic border

### Requirement: Material Design selects
The system SHALL display select dropdowns with Material Design styling consistent with input fields. In dark mode, selects SHALL use glassmorphic styling.
...
#### Scenario: Select dark mode display
- **WHEN** dark mode is active and a select field is rendered
- **THEN** the select SHALL have a semi-transparent background and glassmorphic styling

### Requirement: Material Design textareas
The system SHALL display textareas with Material Design styling and appropriate height. In dark mode, textareas SHALL use glassmorphic styling.
...
#### Scenario: Textarea dark mode display
- **WHEN** dark mode is active and a textarea is rendered
- **THEN** the textarea SHALL have a semi-transparent background and glassmorphic styling

### Requirement: Material Design buttons
The system SHALL display buttons with Material Design styling including elevation and hover states. In dark mode, buttons SHALL use adapted colors for dark backgrounds.
...
#### Scenario: Button dark mode display
- **WHEN** dark mode is active and a primary button is rendered
- **THEN** the button SHALL have a lighter primary color background for visibility on dark surfaces

### Requirement: Material Design toggle switch
The system SHALL display a toggle switch with Material Design styling for binary selections. In dark mode, the toggle SHALL use adapted colors.
...
#### Scenario: Toggle switch dark mode display
- **WHEN** dark mode is active and a toggle switch is rendered
- **THEN** the track SHALL have a semi-transparent background and the thumb SHALL be a light color

### Requirement: Form container glassmorphic styling
The system SHALL display the form container with glassmorphic styling in dark mode.

#### Scenario: Form container in dark mode
- **WHEN** dark mode is active and the movement form is rendered
- **THEN** the form container SHALL have a semi-transparent background, backdrop blur, and subtle border

#### Scenario: Form container in light mode
- **WHEN** light mode is active and the movement form is rendered
- **THEN** the form container SHALL retain its existing solid background styling
