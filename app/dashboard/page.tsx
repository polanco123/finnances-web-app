...
function CategoryBars({ meses }: { meses: string }) {
  ...
  return (
    <div className="dash-card">
      ...
      <div className="category-bars">
        {categorias.map((cat) => (
          <div key={cat.nombre} className="category-bar">
            <div className="category-bar__header">
              <span className="category-bar__name">{cat.nombre}</span>
              <span className="category-bar__amount">{formatCurrency(cat.total)}</span>
            </div>
            <div className="category-bar__track">
              <div
                className="category-bar__fill category-bar__fill--accent"
    ...
    <div className="dash-card">
      ...
      <div className="summary-row">
        <div className="summary-stat">
          <p className="summary-stat__value" style={{ color: 'var(--negative)' }}>{formatCurrency(totalGastado)}</p>
          <p className="summary-stat__label">Total gastos</p>
        </div>
        <div className="summary-stat">
          <p className="summary-stat__value" style={{ color: 'var(--text-secondary)' }}>{formatCurrency(compromisos)}</p>
          <p className="summary-stat__label">Compromisos</p>
        </div>
        <div className="summary-stat">
          <p className="summary-stat__value" style={{ color: 'var(--accent-500)' }}>{formatCurrency(discrecionales)}</p>
    ...
    <div className="dashboard">
      <div className="dashboard__container">
        ...
        <div className="dashboard__grid">
          ...
          <CategoryBars meses={mesSeleccionado} />
